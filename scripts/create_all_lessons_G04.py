#!/usr/bin/env python3
"""ModelIt! Batch Generator - G04-L01 through G04-L10 (Grade 4)"""
import os, sys, time, base64, requests
from lesson_data_G04 import ALL_LESSONS
...
BASE_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'materials', 'grade-04')
...
if __name__ == "__main__":
    print("="*60)
    print("ModelIt! Batch Generator - G04-L01 through G04-L10")
    print("="*60)
