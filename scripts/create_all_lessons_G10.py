#!/usr/bin/env python3
"""
ModelIt! Batch Generator - Grade 10 (Levels 1, 2, 3)

Usage:
    python create_all_lessons_G10.py 1      # Generate Level 1 only
    python create_all_lessons_G10.py 2      # Generate Level 2 only
    python create_all_lessons_G10.py 3      # Generate Level 3 only
    python create_all_lessons_G10.py 1 2 3  # Generate all levels
    python create_all_lessons_G10.py        # Generate all levels (default)
"""
...
AGE_RANGE = "15-16 years old"

LEVEL_CONFIG = {
    1: {
        "label": "10th Grade \u2014 Level 1: How the World Works",
        "short": "Level 1: How the World Works",
        "base_dir": os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'materials', 'grade-10', 'level-1'),
        "import": "lesson_data_G10_L1",
    },
    2: {
        "label": "10th Grade \u2014 Level 2: Systems Under Pressure",
        "short": "Level 2: Systems Under Pressure",
        "base_dir": os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'materials', 'grade-10', 'level-2'),
        "import": "lesson_data_G10_L2",
    },
    3: {
        "label": "10th Grade \u2014 Level 3: Advanced Engineering & Design",
        "short": "Level 3: Advanced Engineering & Design",
        "base_dir": os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'materials', 'grade-10', 'level-3'),
        "import": "lesson_data_G10_L3",
    },
}
...
def run_level(level_num):
    ...
    print(f"\n{'='*60}")
    print(f"ModelIt! Batch Generator - Grade 10 {cfg['short']}")
    print(f"{'='*60}")
...
if __name__ == "__main__":
    ...
    print("="*60)
    print("ModelIt! Grade 10 Generator")
