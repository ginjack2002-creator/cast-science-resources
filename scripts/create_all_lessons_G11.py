#!/usr/bin/env python3
"""
ModelIt! Batch Generator - Grade 11 (Levels 1, 2, 3)

Usage:
    python create_all_lessons_G11.py 1      # Generate Level 1 only
    python create_all_lessons_G11.py 2      # Generate Level 2 only
    python create_all_lessons_G11.py 3      # Generate Level 3 only
    python create_all_lessons_G11.py 1 2 3  # Generate all levels
    python create_all_lessons_G11.py        # Generate all levels (default)
"""
...
AGE_RANGE = "16-17 years old"

LEVEL_CONFIG = {
    1: {
        "label": "11th Grade \u2014 Level 1: Science & Society",
        "short": "Level 1: Science & Society",
        "base_dir": os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'materials', 'grade-11', 'level-1'),
        "import": "lesson_data_G11_L1",
    },
    2: {
        "label": "11th Grade \u2014 Level 2: Complex Systems & Sustainability",
        "short": "Level 2: Complex Systems & Sustainability",
        "base_dir": os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'materials', 'grade-11', 'level-2'),
        "import": "lesson_data_G11_L2",
    },
    3: {
        "label": "11th Grade \u2014 Level 3: Emerging Science & Technology",
        "short": "Level 3: Emerging Science & Technology",
        "base_dir": os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'materials', 'grade-11', 'level-3'),
        "import": "lesson_data_G11_L3",
    },
}
...
def run_level(level_num):
    ...
    print(f"\n{'='*60}")
    print(f"ModelIt! Batch Generator - Grade 11 {cfg['short']}")
    print(f"{'='*60}")
...
if __name__ == "__main__":
    ...
    print("="*60)
    print("ModelIt! Grade 11 Generator")
